...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/sx/anaconda3/include', '-fdebug-prefix-map=/tmp/build/80754af9/python_1599203911753/work=/usr/local/src/conda/python-3.8.5', '-fdebug-prefix-map=/home/sx/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPFLAGS = ['/usr/include/boost/', '/usr/include/boost/']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES = ['_DEBUG']
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/sx/anaconda3/include', '-fdebug-prefix-map=/tmp/build/80754af9/python_1599203911753/work=/usr/local/src/conda/python-3.8.5', '-fdebug-prefix-map=/home/sx/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
...
EXAMPLE_DIRECTORIES = ['naming', 'stats', 'ipv6', 'routing', 'realtime', 'energy', 'tutorial', 'wireless', 'tcp', 'error-model', 'traffic-control', 'udp', 'matrix-topology', 'socket', 'udp-client-server']
...
INCLUDES_PYEMBED = ['/home/sx/anaconda3/include/python3.8']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIB = ['boost_serialization', 'boost_serialization']
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_BOOST = ['/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEMBED = ['/home/sx/anaconda3/lib/python3.8/config-3.8-x86_64-linux-gnu', '/home/sx/anaconda3/lib']
LIBPATH_ST = '-L%s'
...
NS3_CONTRIBUTED_MODULES = ['ns3-myapplication', 'ns3-orchestrator', 'ns3-resource-unit', 'ns3-task']
NS3_ENABLED_CONTRIBUTED_MODULES = ['ns3-myapplication', 'ns3-orchestrator', 'ns3-resource-unit', 'ns3-task']
...
NS3_EXECUTABLE_PATH = ['/home/sx/tarballs/ns-allinone-3.32/ns-3.32/build/src/fd-net-device', '/home/sx/tarballs/ns-allinone-3.32/ns-3.32/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/sx/tarballs/ns-allinone-3.32/ns-3.32/build/lib', '/home/sx/tarballs/ns-allinone-3.32/ns-3.32/build']
...
cfg_files = ['/home/sx/tarballs/ns-allinone-3.32/ns-3.32/build/ns3/config-store-config.h', '/home/sx/tarballs/ns-allinone-3.32/ns-3.32/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
